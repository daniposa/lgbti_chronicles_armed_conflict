...
export const CHRONICLE_T3_16: LocalizedModalContent = {
  ...
  rawText: {
    ...
    fr: `<p>« Ces groupes armés non seulement menaçaient et faisaient pression sur les femmes trans qui travaillaient dans la cosmétique. Mais ils exerçaient également de la violence psychologique et physique ainsi que de l’extorsion. Ils les faisaient payer beaucoup. Les gens pensent que tout le truc d'extorsion c’était seulement en campagne mais non. Beaucoup de ces groupes des <b>{1}AUC{/1}</b> ou de la guérilla qui étaient dans les banlieues des villes encaissaient aussi des “<b>{2}taxes{/2}</b>” ».</p><p class="identificador"><i>Femme trans</i></p>`,
