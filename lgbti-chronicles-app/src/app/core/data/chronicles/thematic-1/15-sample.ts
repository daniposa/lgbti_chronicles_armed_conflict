...
`,
    fr: `<p>Comme indiqué précédemment, les <b><u>{1}FARC-EP{/1}</b></u> considéraient les personnes LGBTIQ+ comme des « commères infiltrées » d’autres factions, ce qui constituait une raison suffisante pour les éliminer. La Commission a pris connaissance de ce qui est arrivé à Nasly, originaire de Cartagena del Chairá (Caquetá), victime de menaces, de torture et de déplacement forcé, perpétrés par le Front 14 en 1996 :</p><p>« Un jour, nous célébrions la Journée de la femme dans la <b><u><i>{2}vereda{/2}</i></u></b> quand deux hommes sont arrivés pour m’insulter, en me traitant de gouine et d’autres choses [...] on me menaçaient “on va te tuer”, “on va te violer”, et ainsi de suite. On a renversé ma table et jeté mon verre par terre ; puis, on s’est sont jeté sur moi. La communauté leur a dit d’arrêter, de me respecter, que j’étais l’infirmière du poste de santé de la vereda, qu’on devait me respecter. Alors la communauté est intervenue et on est parti [...]. Je suis partie et j’ai parlé au médecin qui était le coordinateur ici à l’ESE [entreprise sociale de l’État], ce qui était alors l’Hôpital Cartagena [...] il m’a dit “il n'y a pas d’autre solution que de partir, viens et je t’enverrai ailleurs parce qu’ils vont te tuer.” Alors je suis partie, j’ai pris toutes mes affaires et il m’a envoyé au 52e kilomètre de la route. »</p><p><i>Femme</i></p>
`,
    en: `<p>As previously stated, the <b><u>{1}FARC-EP{/1}</b></u> claimed that the members of the LGBTIQ+ community were “gossip-mongering infiltrators” from other groups, and that was reason enough to get rid of them. The Commission learned about what happened to Nasly, from Cartagena del Chairá, in Caquetá, a victim of threats, torture, and forced displacement by the 14th FARC-EP Front in 1996:</p><p>“One day, we were celebrating Women’s Day in the <b><u><i>{2}vereda{/2}</i></u></b> when two men came and started to insult me, to call me a dyke and other slurs... to threaten me: ‘we’re gonna kill you,’ or ‘we’re gonna rape you,’ and so on. Then, they flipped my table over, spilled my drink, and jumped me. The people there told them to stop, to show some respect, that I was the nurse at the vereda’s health services post, and that I deserved respect. So, the community intervened, and the men left... I went to talk with the doctor who was coordinating the Empresa Social del Estado [Statal Social Organization-ESE], known as the Hospital Cartagena back then... he said, ‘there’s no other option now but for you to leave. I’ll send you somewhere else, otherwise, they are going to kill you.’ And so, I left. I packed all my stuff, and the doctor sent me to the 52nd kilometer of the road.”</p><p><i>Lesbian woman</i></p>
`,
  },
  tooltips: {
    1: {
...
<p><a href="https://conceptos.dane.gov.co/conceptos/conceptos/6002/ficha/" target="_blank" rel="noopener noreferrer">DANE</a></p>`,
  ...
  contextInfo: {
    es: `Lugar: Cartagena del Chairá</p><p>Año: 1996 </p><p>Hecho(s) victimizante(s): amenazas, tortura, desplazamiento forzado</p><p>Actor armado: Frente 14 de las FARC-EP</p>`,
    ...
    en: `Place: Cartagena del Chairá</p><p>Date: 1996 </p><p>Victimizing act(s): threats, torture, forced displacement</p><p>Armed actor: FARC-EP 14th Front</p>`,
  },
};
